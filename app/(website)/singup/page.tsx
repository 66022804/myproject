  ...
  return (
    <div className="flex flex-col justify-center items-center ml-64 mt-5">
      <Image
        ...
        objectFit="contain"
      />
      <h1 className="text-shadow-xl text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#FFB100] to-[#FFE6AD]">Welcome to FoodFusion!</h1>
      <div className="flex items-center mt-3">
        <p className="text-xl text-[#FFC94E] ">Already Have an account? </p>
        <Link className="ml-2 text-xl font-bold text-[#A97500] underline decoration-[#A97500] hover:text-[#FFB100] hover:decoration-[#FFB100]" href="/login"> Log in </Link>
      </div>

    {/* Name input */}
    <div className="my-3 w-full max-w-[300px]">
      <label htmlFor="name" className="block text-sm font-medium text-[#A97500]"></label>
      <input 
        type="text" 
        id="name" 
        name="name" 
    ...
    <div className="flex justify-center  mr-[120px] mb-1">
     ...
     <div className="flex items-center my-3 w-full justify-center">
      ...
      <div className="flex items-center w-full justify-center ">
       <i className="fa-brands fa-google text-2xl mr-10"></i>
       <i className="fa-brands fa-facebook text-2xl mr-10"></i>
